            ...
            try {
                ...
                switch ($state) {
                    ...
                    case 2:
                        ...
                        $data_post = $telConfig->getWelcomeWindow($data, 'Чтобы разместить пост во всех соцсетях, просто пришлите боту текст сообщения, фото или видео – после этого бот спросит Вас опубликовать немедленно или в заданное время. Без Вашего подтверждения ничего публиковаться не будет.
